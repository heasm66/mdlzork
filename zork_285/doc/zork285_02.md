...
This is part 2 in an ongoing series. "Part 1 - Introduction and the sources" is [here](https://github.com/heasm66/mdlzork/blob/master/zork_285/doc/zork285_01.md).  
...
Next: [Extracting definitions for rooms and objects]()

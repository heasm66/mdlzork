...
with the ``ÈSC```-key restored, otherwise the game, and the environment quits.
...
## The main loop - RDCOM
RDCOM is in the file [```ROOMS 154 [Jun 14 1977]```](https://https://github.com/MITDDC/zork-1977-07/blob/main/zork/9005183/marc/rooms.154). This function is the heart of the program. I will go through this function in some detail.
```
